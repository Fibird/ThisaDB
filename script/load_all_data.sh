...
echo "LOAD PART (\"$benchmark_dir/part.tbl\");" | ./thisadb $dbname
...
echo "LOAD SUPPLIER (\"$benchmark_dir/supplier.tbl\");" | ./thisadb $dbname
...
echo "LOAD PARTSUPP (\"$benchmark_dir/partsupp.tbl\");" | ./thisadb $dbname
...
echo "LOAD CUSTOMER (\"$benchmark_dir/customer.tbl\");" | ./thisadb $dbname
...
echo "LOAD ORDERS (\"$benchmark_dir/orders.tbl\");" | ./thisadb $dbname
...
echo "LOAD LINEITEM (\"$benchmark_dir/lineitem.tbl\");" | ./thisadb $dbname
